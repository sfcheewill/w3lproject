...
<html>
  ...
  <div class="container" style=""> 
   ...
   <div class="warp warp-content clearfix" style="min-height: 791px;"> 
    <div class="contentArea clearfix"> 
     ...
     <input type="hidden" name="gname" value="{{$data['gname']}}">
     {{csrf_field()}}
      <li> <button class="confirmPay pull-right" name="msg_payBtn">确认支付</button>
      </form> 
       <div id="cashCoupon"> 
       </div> </li> 
 ...
 <script>
  ...
  $('.confirmPay').click(function(){
    $.get('/checkorder',function(data){
      if(data != 'success'){
        //订单失效
        alert('当前订单已失效,请重新选择商品');
        return false;
      }
    })
  });
