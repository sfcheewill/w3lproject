 ...
 /*
  ...
  <div class="g"> 
   ...
   <div class="breadcrumb-area fcn"> 
    <a href="https://www.vmall.com/" title="首页">首页</a>&nbsp;&gt;&nbsp; 
    <span>笔记本 &amp; 平板</span> 
   </div> 
  </div> 
  <div class="hr-10"></div> 
  ...
  <div class="layout"> 
   ...
   <div class="pro-cate-area"> 
    ...
    <div class="pro-cate-attr clearfix"> 
     ...
     <div class="p-default"> 
      <ul> 
       <li id="first-category" class="selected"><a href="https://www.vmall.com/list-40">全部</a></li> 
     ...
     <div class="p-values"> 
      ...
      <div class="p-expand"> 
       <ul class="clearfix"> 
        <li><a href="https://www.vmall.com/list-41">平板电脑</a></li> 
        <li><a href="https://www.vmall.com/list-42">笔记本电脑</a></li> 
        <li><a href="https://www.vmall.com/list-317">笔记本配件</a></li> 
       </ul> 
      </div> 
     </div> 
    </div>
  ...
  <script id="jsapi_loader4" loadtype="insert" type="text/javascript" src="/static/homes/goodslist/jquery.form-2.49.js" charset="utf-8"></script>
  ...
  <script id="jsapi_loader5" loadtype="insert" type="text/javascript" src="/static/homes/goodslist/ajax.js" charset="utf-8"></script>
  ...
  <script id="jsapi_loader6" loadtype="insert" type="text/javascript" src="/static/homes/goodslist/pager-min.js" charset="gbk"></script>
  <script>(function(){var time = 0,el = document.getElementById('jsapi_loader6');if(!el || (el.readyState && 'complete' != el.readyState)){ if(time<10){ setTimeout(arguments.callee,30); time++; }else{ logger.error('load the script of id jsapi_loader6 fail!');} return; }ol._setLoadStatus("ec.pager/pager-min.js","complete");})();</script> 
  <div class="layout"> 
     ...
     <ul> 
      <li> 
       <div class="pro-panels"> 
        <p class="p-img"><a target="_blank" href="https://www.vmall.com/product/241920871.html" title="华为平板 M3" onclick="pushListProClickMsg('1201010004002')"><img alt="华为平板 M3 4GB+64GB  LTE版（日晖金）" src="/static/homes/goodslist/428_428_1473405520524mp.jpg" /></a></p> 
        <p class="p-name"> <a target="_blank" href="https://www.vmall.com/product/241920871.html" title="华为平板 M3" onclick="pushListProClickMsg('1201010004002')"> <span>华为平板 M3</span> <span class="red"></span> </a> </p> 
        <p class="p-price"><b>&yen;2688</b></p> 
        <div class="p-button clearfix"> 
         <table colspan="0" border="0" rowspan="0"> 
          <tbody> 
           <tr> 
            <td><a target="_blank" href="https://www.vmall.com/product/241920871.html" class="p-button-cart"><span>选购</span></a></td> 
