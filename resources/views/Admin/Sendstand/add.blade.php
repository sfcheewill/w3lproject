...
@section('content')
	<div class="mws-panel grid_8">
          ...
          <div class="mws-panel-body no-padding">
          	<form class="mws-form" action="/sendstand" method="post" enctype="multipart/form-data">
          	@if (count($errors) > 0)
				...
				<div class="mws-form-inline">
	                   <div class="mws-form-row">
          				...
          				<div class="mws-form-item">
          					<input type="text" class="large" name="type" value="">
          				</div>
          			</div>
                         <div class="mws-form-row">
                         ...
                         <div class="mws-form-row">
                              ...
                              <div class="mws-form-item">
                                   <script id="editor" type="text/plain" name="content" style="width:1200px;height:500px;">
                                   </script>
                              </div>
                         </div>                 
          		</div>
