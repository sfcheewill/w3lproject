...
@section('content')
	<div class="mws-panel grid_8">
          ...
          <div class="mws-panel-body no-padding">
          	<form class="mws-form" action="/award" method="post" enctype="multipart/form-data">
          	@if (count($errors) > 0)
				...
				<div class="mws-form-inline">
	                <div class="mws-form-row">
          				...
          				<div class="mws-form-item">
          					<input type="text" class="large" name="aprice" value="">
          				</div>
          			</div>
	                <div class="mws-form-row">
	                    <label class="mws-form-label">优惠券图片</label>
	                    <div class="mws-form-item">
