     ...
     <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info"> 
      <thead> 
       <tr role="row">
        ...
        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 226px;">备注</th>
        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 334px;">操作</th>
       </tr> 
      </thead> 
       ...
       <tr class="odd"> 
        ...
        <form action="/adminrolelist/{{$value->id}}" method="post" style="display: inline-block;">
          ...
          <button href="" class="btn btn-danger del">删除</button>
            ...
            <a href="/adminauth/{{$value->id}}" class="btn btn-success">分配权限</a>
            <a href="/adminrolelist/{{$value->id}}" class="btn btn-success">查看</a>
        </td> 
       </tr>
       @endforeach
      </tbody>
