     ...
     <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info"> 
      <thead> 
       <tr role="row">
        ...
        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 200px;">title</th>
        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 200px;">最新添加时间</th>
      ...
      @foreach($data as $value)
       <tr class="odd" >
        ...
        <td class="" style="width:15%">{{$value->title}}</td> 
        <td class="" style="width:15%">{{date('Y-m-d H:i:s',$value->addtime)}}</td>
        <td class="sorting_1 "><img src="{{$value->pic}}" alt="" width="600px" height="240px" /></td> 
        <td class=" " style="width:10%">
        <form action="/advertising/{{$value->id}}" method="post" style="display: inline-block;">
          {{method_field('DELETE')}}
          {{csrf_field()}}
