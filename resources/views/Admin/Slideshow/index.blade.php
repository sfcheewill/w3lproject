     ...
     <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info"> 
      ...
      @foreach($data as $value)
       <tr class="odd" >
        ...
        <td class=" "><img src="{{$value->picture}}" alt="" style="height: 120px;" /></td> 
        <td class=" " style="width:10%">
        <form action="/adminslideshow/{{$value->id}}" method="post" style="display: inline-block;">
          {{method_field('DELETE')}}
          {{csrf_field()}}
          <button href="" class="btn btn-danger del">删除</button>
        </form>
            <!-- <a href="/adminslideshow/{{$value->id}}/edit" class="btn btn-info">修改</a> -->
        </td> 
       </tr>
       @endforeach
      </tbody>
